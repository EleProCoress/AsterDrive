...
import { UrlTemplatePreview } from "@/components/files/preview/viewers/external/UrlTemplatePreview";
...
vi.mock("@/components/files/preview/shared/PreviewLoadingState", () => ({
