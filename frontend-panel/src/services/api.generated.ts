...
export interface components {
    schemas: {
        ...
        ApiErrorInfo: {
            diagnostic?: null | components["schemas"]["ApiErrorDiagnostic"];
            retryable: boolean;
        };
        /**
...
export interface operations {
    ...
    finish_storage_authorization: {
        ...
        requestBody?: never;
        responses: {
            /** @description Storage credential authorization callback handled and redirected to the admin policies page with success or error state */
            302: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    list_storage_driver_descriptors: {
        ...
        requestBody?: never;
        responses: {
            /** @description List storage driver capability descriptors */
            200: {
                headers: {
                    [name: string]: unknown;
                };
