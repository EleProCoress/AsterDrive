...
export interface components {
    schemas: {
        /** @description Accept a user invitation by choosing account credentials. */
        ...
        /** @description Create a new user invitation (admin operation). */
        ...
        OfflineDownloadTaskResult: {
            ...
            /**
             * @description Actual engine used for the final successful transfer. Legacy task
             *     results may not have this field.
             */
            download_engine?: string | null;
            /** Format: int64 */
            file_id: number;
            file_name: string;
            file_path: string;
...
export interface operations {
    ...
    migrate_policy_group_assignments: {
        ...
        responses: {
            /** @description Policy group assignments migrated */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    finish_passkey_login: {
        ...
        responses: {
            /** @description Passkey login successful or password change required, tokens set in HttpOnly cookies */
            200: {
                headers: {
                    [name: string]: unknown;
                };
