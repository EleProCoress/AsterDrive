...
| WOPI | The Office online preview/editing protocol. AsterDrive provides file APIs while OnlyOffice / Collabora and similar services open the files. | [File Editing](./editing) |
...
| Audit log | Records important user and admin actions for troubleshooting, tracing, and routine checks. | [Admin Console](./admin-console) |
