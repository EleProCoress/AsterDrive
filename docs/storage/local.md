...
如果你希望把容量和带宽交给对象存储，看 [S3 / MinIO / R2](/storage/s3-minio-r2) 或 [腾讯云 COS](/storage/tencent-cos)。如果你希望主控节点和真实对象落点拆开，看 [远程节点存储策略](/storage/remote-follower)。
