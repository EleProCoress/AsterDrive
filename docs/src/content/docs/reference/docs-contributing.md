...
| 概念解释、索引、问题分流、项目介绍 | `reference/` | 架构概览、术语表、常见问题速查、错误码、关于 |
...
- `docs/src/content/docs/storage/index.md`
- `docs/src/content/docs/config/storage.md`
- `docs/src/content/docs/features/upload-storage.md`
...
文档站用 Astro Starlight 构建，没有顶栏下拉菜单，全站导航就是固定侧边栏，不按目录切换。它的目标是让读者始终知道整本文档的结构。
