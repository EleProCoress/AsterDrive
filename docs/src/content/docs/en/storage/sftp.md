...
title: "SFTP Storage Policy Tutorial"
---
...
:::caution[Do not manually move objects in the remote directory]
...
:::caution[Do not bypass host key confirmation]
...
:::caution[Do not directly change these fields on an SFTP policy that already has files]
